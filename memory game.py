...
def draw_backgrounds():
    highscore = str(load_data())  # set variable highscore into loaded data from file
    ...
    best_text = small_font.render(f'High Score: {highscore}', True, white)
...
while running:
    ...
    load_data()  # from load data function
