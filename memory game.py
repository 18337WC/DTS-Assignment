...
winner_font = pygame.font.SysFont('freesansbold', 60)
...
while running:
    ...
    if matches == rows * cols // 2:
        ...
        winner_text = winner_font.render(f'You Won in {score} Turns!', True, white)
        screen.blit(winner_text, (100, HEIGHT - 290))
